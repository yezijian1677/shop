...
public class LogAspectj {
    ...
    @Before("execution(* cur.pro.controller.*Controller.*(..)) && !execution( * cur.pro.controller.AbstractController.*(..))")
    // 切面为controller中的所有方法
    ...
    @AfterThrowing(value = "execution(* cur.pro.controller.*Controller.*(..)) && !execution( * cur.pro.controller.AbstractController.*(..))", throwing = "e")
    // 切面为controller中的所有方法
