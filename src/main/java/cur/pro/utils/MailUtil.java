...
public class MailUtil {
    ...
    private final static String USERNAME = "yzjtjut@163.com";
    private final static String PASSWORD = "yzjhaha123";           // 需要打开SMTP并使用此授权码登录
    ...
    public static void sendValidateMail(String user, String code) {
        ...
        String title = "EasyGo注册验证码";
        String content = "感谢您注册EasyGo，您的验证码为 \n" + code + "\n，请注意保存，此验证码有效期为 10分钟 ，并且只能使用一次。";
    ...
    public static void sendFetchPwdMail(String user, String code) {
        ...
        String title = "EasyGo找回密码";
        String content = "这封邮件是在验证您的EasyGo邮箱，用来找回密码，如果不是您本人的操作，请忽略此邮件。\n您的验证码为 \n" + code + "\n请注意保存，此验证码有效期为 10分钟 ，并且只能使用一次。";
