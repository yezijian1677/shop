    ...
    <div class="row">
        <div class="row bjys ztys dlkwz">
            ...
            <div class="col-xs-4">
                <h1 class="btys">创建</h1>
                <h5>一个免费的EasyGo账户</h5>
                <h5>欢迎免费加入及轻松使用。继续创建EasyGo 帐户<br/>
                    并获取 EasyGo - 适合 PC 和 Mac 玩家的前沿数字解决<br/>
                    方案。</h5>
                <a href="/register">
                    <button type="submit" class="btnys"><p class="btys">加入EasyGo</p></button>
                </a>
            </div>
            <div class="col-xs-4">
                <h3 class="btys">为什么加入EasyGo？</h3>
                <ul type="disc">
                    <li>购买和下载完整零售游戏</li>
                    <li>加入EasyGo社区</li>
                    <li>游戏时与好友聊天</li>
